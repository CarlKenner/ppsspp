...
const KeyMap_IntStrPair psp_button_names[] = {
	...
	{ VIRTKEY_FREELOOK_DECREASE_SPEED, "Freelook Slow"},
	{ VIRTKEY_FREELOOK_INCREASE_SPEED, "Freelook Fast"},
	{ VIRTKEY_FREELOOK_RESET_SPEED, "Freelook Normal" },
	{ VIRTKEY_FREELOOK_UP, "Freelook Up"},
	{ VIRTKEY_FREELOOK_DOWN, "Freelook Down"},
	{ VIRTKEY_FREELOOK_LEFT, "Freelook Left"},
	{ VIRTKEY_FREELOOK_RIGHT, "Freelook Right"},
	{ VIRTKEY_FREELOOK_ZOOM_IN, "Freelook Fwd"},
	{ VIRTKEY_FREELOOK_ZOOM_OUT, "Freelook Back"},
	{ VIRTKEY_FREELOOK_RESET, "Freelook Reset"},
	{ VIRTKEY_PERMANENT_CAMERA_FORWARD, "Perm Cam Fwd"},
	{ VIRTKEY_PERMANENT_CAMERA_BACKWARD, "Perm Cam Back"},
	{ VIRTKEY_LARGER_SCALE, "Less Per Metre"},
	{ VIRTKEY_SMALLER_SCALE, "More Per Metre"},
	{ VIRTKEY_GLOBAL_LARGER_SCALE, "Larger Scale"},
	{ VIRTKEY_GLOBAL_SMALLER_SCALE, "Smaller Scale"},
	{ VIRTKEY_CAMERA_TILT_UP, "Tilt Cam Up"},
	{ VIRTKEY_CAMERA_TILT_DOWN, "Tilt Cam Down"},

	{ VIRTKEY_HUD_FORWARD, "HUD Fwd"},
	{ VIRTKEY_HUD_BACKWARD, "HUD Back"},
	{ VIRTKEY_HUD_THICKER, "HUD Thicker"},
	{ VIRTKEY_HUD_THINNER, "HUD Thinner"},
	{ VIRTKEY_HUD_3D_CLOSER, "HUD 3D Back"},
	{ VIRTKEY_HUD_3D_FURTHER, "HUD 3D Fwd"},

	{ VIRTKEY_2D_SCREEN_LARGER, "2D Larger"},
	{ VIRTKEY_2D_SCREEN_SMALLER, "2D Smaller"},
	{ VIRTKEY_2D_CAMERA_FORWARD, "2D Cam Fwd"},
	{ VIRTKEY_2D_CAMERA_BACKWARD, "2D Cam Back"},
	//{VIRTKEY_2D_SCREEN_LEFT, "2D Scr Left"}, //Doesn't exist right now?
	//{VIRTKEY_2D_SCREEN_RIGHT, "2D Scr Right"}, //Doesn't exist right now?
	{ VIRTKEY_2D_CAMERA_UP, "2D Cam Up"},
	{ VIRTKEY_2D_CAMERA_DOWN, "2D Cam Down"},
	{ VIRTKEY_2D_CAMERA_TILT_UP, "2D Tilt Up"},
	{ VIRTKEY_2D_CAMERA_TILT_DOWN, "2D Tilt Down"},
	{ VIRTKEY_2D_SCREEN_THICKER, "2D Thicker"},
	{ VIRTKEY_2D_SCREEN_THINNER, "2D Thinner"},

	{ VIRTKEY_DEBUG_PREVIOUS_LAYER, "Debug Prev"},
	{ VIRTKEY_DEBUG_NEXT_LAYER, "Debug Next"},
	{ VIRTKEY_DEBUG_SCENE, "Debug Scene"},
