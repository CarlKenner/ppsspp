...
#endif
	ConfigSetting("InternalScreenRotation", &g_Config.iInternalScreenRotation, 1, true, true),
...
static ConfigSetting graphicsSettings[] = {
	...
	ReportedConfigSetting("Wireframe", &g_Config.bWireFrame, false, true, false),
...
static ConfigSetting vrSettings[] = {
	...
	ConfigSetting("BruteForceFramesLeft", &g_Config.BruteForceFramesLeft, 0),
	ConfigSetting("BruteForceFramesToRunFor", &g_Config.BruteForceFramesToRunFor, 4),
	ConfigSetting("BruteForceFunctionCount", &g_Config.BruteForceFunctionCount, 0),
	ConfigSetting("BruteForceOriginalVertexCount", &g_Config.BruteForceOriginalVertexCount, 0),
	ConfigSetting("BruteForceReturnCode", &g_Config.BruteForceReturnCode, 0),
	ConfigSetting("BruteForceFileName", &g_Config.sBruteForceFileName, ""),

	ConfigSetting("BruteForceEnableVR", &g_Config.BruteForce_bEnableVR, true),
	ConfigSetting("BruteForceVSyncInterval", &g_Config.BruteForce_bVSync, false),
	ConfigSetting("BruteForceHardwareTransform", &g_Config.BruteForce_bHardwareTransform, true),
	ConfigSetting("BruteForceEnableSound", &g_Config.BruteForce_bEnableSound, true),
	ConfigSetting("BruteForceEnableLogging", &g_Config.BruteForce_bEnableLogging, true),
	ConfigSetting("BruteForceInternalResolution", &g_Config.BruteForce_iInternalResolution, &DefaultInternalResolution),
	ConfigSetting("BruteForceAnisotropyLevel", &g_Config.BruteForce_iAnisotropyLevel, 8),
	ConfigSetting("BruteForceTexScalingLevel", &g_Config.BruteForce_iTexScalingLevel, 1),
	ConfigSetting("BruteForceFreeLookX", &g_Config.BruteForceFreeLook[0], 0.0f),
	ConfigSetting("BruteForceFreeLookY", &g_Config.BruteForceFreeLook[1], 0.0f),
	ConfigSetting("BruteForceFreeLookZ", &g_Config.BruteForceFreeLook[2], 0.0f),
	...
	ReportedConfigSetting("NoMirrorToWindow", &g_Config.bNoMirrorToWindow, true),
	...
	ReportedConfigSetting("ShowSensorBar", &g_Config.bShowSensorBar, false),
	ReportedConfigSetting("ShowGameCamera", &g_Config.bShowGameCamera, false),
	ReportedConfigSetting("ShowGameFrustum", &g_Config.bShowGameFrustum, false),
	ReportedConfigSetting("ShowTrackingCamera", &g_Config.bShowTrackingCamera, false),
	ReportedConfigSetting("ShowTrackingVolume", &g_Config.bShowTrackingVolume, false),
	ReportedConfigSetting("ShowBaseStation", &g_Config.bShowBaseStation, false),
	ReportedConfigSetting("MotionSicknessAlways", &g_Config.bMotionSicknessAlways, false),
	ReportedConfigSetting("MotionSicknessFreelook", &g_Config.bMotionSicknessFreelook, false),
	ReportedConfigSetting("MotionSickness2D", &g_Config.bMotionSickness2D, false),
	ReportedConfigSetting("MotionSicknessLeftStick", &g_Config.bMotionSicknessLeftStick, false),
	ReportedConfigSetting("MotionSicknessRightStick", &g_Config.bMotionSicknessRightStick, false),
	ReportedConfigSetting("MotionSicknessDPad", &g_Config.bMotionSicknessDPad, false),
	ReportedConfigSetting("MotionSicknessIR", &g_Config.bMotionSicknessIR, false),
	ReportedConfigSetting("MotionSicknessMethod", &g_Config.iMotionSicknessMethod, 0),
	ReportedConfigSetting("MotionSicknessSkybox", &g_Config.iMotionSicknessSkybox, 0),
	ReportedConfigSetting("MotionSicknessFOV", &g_Config.fMotionSicknessFOV, DEFAULT_VR_MOTION_SICKNESS_FOV),
	ReportedConfigSetting("Player", &g_Config.iVRPlayer, 0),
	ReportedConfigSetting("TimewarpTweak", &g_Config.fTimeWarpTweak, DEFAULT_VR_TIMEWARP_TWEAK),
	ReportedConfigSetting("NumExtraFrames", &g_Config.iExtraTimewarpedFrames, DEFAULT_VR_EXTRA_FRAMES),
	ReportedConfigSetting("NumExtraVideoLoops", &g_Config.iExtraVideoLoops, DEFAULT_VR_EXTRA_VIDEO_LOOPS),
	ReportedConfigSetting("NumExtraVideoLoopsDivider", &g_Config.iExtraVideoLoopsDivider, DEFAULT_VR_EXTRA_VIDEO_LOOPS_DIVIDER),
	ReportedConfigSetting("StabilizeRoll", &g_Config.bStabilizeRoll, true),
	ReportedConfigSetting("StabilizePitch", &g_Config.bStabilizePitch, true),
	ReportedConfigSetting("StabilizeYaw", &g_Config.bStabilizeYaw, false),
	ReportedConfigSetting("StabilizeX", &g_Config.bStabilizeX, false),
	ReportedConfigSetting("StabilizeY", &g_Config.bStabilizeY, false),
	ReportedConfigSetting("StabilizeZ", &g_Config.bStabilizeZ, false),
	ReportedConfigSetting("Keyhole", &g_Config.bKeyhole, false),
	ReportedConfigSetting("KeyholeWidth", &g_Config.fKeyholeWidth, 45.0f),
	ReportedConfigSetting("KeyholeSnap", &g_Config.bKeyholeSnap, false),
	ReportedConfigSetting("KeyholeSnapSize", &g_Config.fKeyholeSnapSize, 30.0f),
	ReportedConfigSetting("PullUp20fps", &g_Config.bPullUp20fps, false),
	ReportedConfigSetting("PullUp30fps", &g_Config.bPullUp30fps, false),
	ReportedConfigSetting("PullUp60fps", &g_Config.bPullUp60fps, false),
	ReportedConfigSetting("OpcodeReplay", &g_Config.bOpcodeReplay, false),
...
static ConfigSetting vrGameSettings[] = {
	ReportedConfigSetting("UnitsPerMetre", &g_Config.fUnitsPerMetre, 1.0f, true, true),
	ReportedConfigSetting("HudThickness", &g_Config.fHudThickness, 0.5f, true, true),
	ReportedConfigSetting("HudDistance", &g_Config.fHudDistance, 1.5f, true, true),
	...
	ReportedConfigSetting("ScreenRight", &g_Config.fScreenRight, 0.0f, true, true),
	ReportedConfigSetting("ScreenUp", &g_Config.fScreenUp, 0.0f, true, true),
	ReportedConfigSetting("ScreenPitch", &g_Config.fScreenPitch, 0.0f, true, true),
	ReportedConfigSetting("TelescopeMaxFOV", &g_Config.fTelescopeMaxFOV, 0.0f, true, true),
	ReportedConfigSetting("Disable3D", &g_Config.bDisable3D, false, true, true),
	...
	ReportedConfigSetting("Invert2DOrthoDepth", &g_Config.bInvert2DOrthoDepth, false, true, true),
